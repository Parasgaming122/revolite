  ...
  const points = [
    {
      ...
      desc: 'We craft timeless logos and visual systems that help growing retail brands stand out.',
      icon: (
    ...
    },
    {
      ...
      desc: 'Every pixel is polished for clarity across all screens, ensuring your brand looks professional on any device.',
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    },
    {
      ...
      desc: 'We don’t just design; we position your brand to grow through deep research and analysis.',
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
